...
public class Ejercicio7 {
	...
	public static void main(String[] args) {
        ...
        do {
            ...
            //Codigo para calcular los minutos faltantes hasta el fin de semana
            //Se checa si hay días enteros antes del fin de semana programado
            //(viernes a las 15:00 horas) y las horas restantes
...
Debe calcular cuantos minutos faltan para el fin de semana. 
Se considera que el fin de semana comienza el viernes a las 15:00 hrs.
Debe mostrar el resultado por consola.
Debe ser capaz de identificar si los datos de entrada son válidos 
(día de la semana válido, hora válida, minutos válidos), 
...
Salida:Faltan 5730 minutos para el fin de semana.
